function Footer() {
    return <div className="footer">
            <ul className="footer-list">
                <li className="footer-list-line"><img src="src/pizza-imgs/footer-circle.png"/></li>
            ...
            <li className="footer-list-line">Nazwa</li>
                ...
                <li className="footer-list-line"><img src="src/pizza-imgs/ig-square.png" alt="ig"/><img src="src/pizza-imgs/ig-square.png" alt="fb"/></li>
            </ul>
        </div>
}
